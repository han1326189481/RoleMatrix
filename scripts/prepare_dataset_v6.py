...
DST = Path(r"D:\RoleMatrix\data\lora_xiaor_real_v6\img")
...
# 旧侧脸照 5 张
OLD_SIDE = {
    "1.jpg": "three quarter view, looking down, white oversized hoodie, indoor, desk, plushies shelf, laptop, dim lighting, focused, realistic",
    "2.jpg": "side profile, looking down, library, wooden bookshelf, bright lighting, quiet atmosphere, realistic",
    "3.jpg": "side profile, looking down, holding drink straw, coffee shop, warm pendant light, casual, realistic",
    "4.jpg": "side profile, night street, illuminated display case, neon lights, cool and warm light, pensive, realistic",
    "5.jpg": "side profile, looking up toward window, hand on chin, bus window, daytime, natural light, realistic",
}
# 补充照片（高清）
NEW = {
    ...
    "侧脸照1.png": "three quarter view, looking at viewer, hand on cheek, sleeves over hands, white oversized hoodie, library, bookshelf, open book on desk, bright soft lighting, realistic",
    "侧脸照2.png": "side profile, looking down, reading, white hoodie with black text, desk, light blue pencil case, window, indoor, warm and cool light, realistic",
